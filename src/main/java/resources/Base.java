...
//		String browserName = prop.getProperty("browser");
		...
		if (browserName.contains("chrome")) {
			...
			options.addArguments("--start-maximized", "enable-automation", "--no-sandbox", "--disable-dev-shm-usage",
					"--disable-gpu", "--disable-blink-features=AutomationControlled", "--disable-extensions",
					"--user-agent=Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/65.0.3325.181 Safari/537.36");
			options.setExperimentalOption("excludeSwitches", new String[] { "enable-automation" });

			if (browserName.contains("headless")) {
				options.addArguments("--window-size=1920,1080", "enable-automation", "--no-sandbox", "--headless",
